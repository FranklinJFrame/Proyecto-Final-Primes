<footer class="bg-black border-t border-blue-500/20 backdrop-blur-sm">
  <div class="w-full max-w-7xl py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
    ...
    <div class="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
      ...
      <!-- Social Brands -->
      <div>
        <a class="w-10 h-10 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-blue-500/20 text-blue-400 hover:bg-blue-500/10 hover:border-blue-500/30 transition-all duration-200" href="#">
