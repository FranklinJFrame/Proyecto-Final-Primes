<div class="min-h-screen bg-black">
  <!-- Navbar con Logo -->
  <nav class="bg-black/50 backdrop-blur-md border-b border-blue-500/20 fixed w-full z-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between items-center h-16">
              <div class="flex items-center">
                  <h1 class="text-2xl font-bold text-white cyber-glitch-text">
                      TECNO<span class="text-blue-500">BOX</span>
                  </h1>
              </div>
              <div class="hidden md:flex items-center space-x-8">
                  <a href="#" class="text-gray-300 hover:text-blue-500 transition-colors">Componentes</a>
                  <a href="#" class="text-gray-300 hover:text-blue-500 transition-colors">PC Gaming</a>
                  <a href="#" class="text-gray-300 hover:text-blue-500 transition-colors">Periféricos</a>
                  <a href="#" class="text-gray-300 hover:text-blue-500 transition-colors">Ofertas</a>
                  <div class="relative">
                      <button class="cyber-button-small px-4 py-2 text-white rounded-lg flex items-center">
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
              ...
              <div class="cyber-category-card group">
                  <div class="relative overflow-hidden rounded-xl">
                      <img src="https://dlcdnwebimgs.asus.com/files/media/9F5C4614-7F00-4C82-B635-B08C7CA5BFCB/v1/img/kv-pd.png" 
                           alt="Procesadores" 
              ...
              <div class="cyber-category-card group">
                  <div class="relative overflow-hidden rounded-xl">
                      <img src="https://dlcdnwebimgs.asus.com/files/media/8C220D6E-40D5-4A3B-A98F-F45783D2E1A4/v1/img/kv-pd.png" 
                           alt="Placas Base" 
                           class="w-full h-48 object-cover transform group-hover:scale-110 transition-transform duration-500">
                      <div class="absolute inset-0 bg-gradient-to-t from-black to-transparent"></div>
                      <div class="absolute bottom-4 left-4">
              ...
              <div class="cyber-category-card group">
                  <div class="relative overflow-hidden rounded-xl">
                      <img src="https://www.corsair.com/medias/sys_master/images/images/h12/hc6/10246735577118/vengeance-rgb-pro-bl-config/Gallery/VENGEANCE_RGB_PRO_BLACK_01/-vengeance-rgb-pro-bl-config-Gallery-VENGEANCE-RGB-PRO-BLACK-01.png_515Wx515H" 
                           alt="Memoria RAM" 
                           class="w-full h-48 object-cover transform group-hover:scale-110 transition-transform duration-500">
                      <div class="absolute inset-0 bg-gradient-to-t from-black to-transparent"></div>
                      <div class="absolute bottom-4 left-4">
              ...
              <div class="cyber-category-card group">
                  <div class="relative overflow-hidden rounded-xl">
                      <img src="https://www.corsair.com/medias/sys_master/images/images/h78/h86/9673265922078/MP600-PRO-NH/Gallery/MP600_PRO_NH_01/-MP600-PRO-NH-Gallery-MP600-PRO-NH-01.png_515Wx515H" 
                           alt="Almacenamiento" 
                           class="w-full h-48 object-cover transform group-hover:scale-110 transition-transform duration-500">
                      <div class="absolute inset-0 bg-gradient-to-t from-black to-transparent"></div>
                      <div class="absolute bottom-4 left-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div class="cyber-product-card">
                  <div class="relative">
                      ...
                      <img src="https://www.corsair.com/medias/sys_master/images/images/h48/hdb/10241663467550/-CH-9109114-SP-Gallery-K65-RGB-MINI-01.png" 
                  ...
                  <div class="p-4">
                      ...
                      <div class="flex justify-between items-center">
                          <div>
                              <span class="text-gray-400 line-through text-sm">RD$ 8,774.42</span>
                              <span class="text-2xl font-bold text-white ml-2">RD$ 7,019.42</span>
                          </div>
              ...
              <div class="cyber-product-card">
                  <div class="relative">
                      ...
                      <img src="https://www.corsair.com/medias/sys_master/images/images/h06/hfe/9582535966750/-CH-9911114-NA-Gallery-Dark-Core-RGB-Pro-01.png" 
                           alt="Ratón Gaming" 
                           class="w-full h-48 object-contain">
                  </div>
                  <div class="p-4">
                      ...
                      <div class="flex justify-between items-center">
                          <div>
                              <span class="text-gray-400 line-through text-sm">RD$ 5,264.42</span>
                              <span class="text-2xl font-bold text-white ml-2">RD$ 4,474.65</span>
                          </div>
                          <button class="cyber-button-small px-4 py-2">
                              Añadir
                          </button>
              ...
              <div class="cyber-product-card">
                  <div class="relative">
                      ...
                      <img src="https://www.corsair.com/medias/sys_master/images/images/hc6/h75/9582533066782/-CA-9011180-NA-Gallery-Void-RGB-Elite-Wireless-WHITE-01.png" 
                  ...
                  <div class="p-4">
                      ...
                      <div class="flex justify-between items-center">
                          <div>
                              <span class="text-gray-400 line-through text-sm">RD$ 7,604.42</span>
                              <span class="text-2xl font-bold text-white ml-2">RD$ 5,703.17</span>
                          </div>
                          <button class="cyber-button-small px-4 py-2">
                              Añadir
                          </button>
              ...
              <div class="cyber-product-card">
                  <div class="relative">
                      ...
                      <img src="https://www.corsair.com/medias/sys_master/images/images/h42/h3f/10299056775198/-CMK32GX4M2E3200C16-Gallery-VENG-LPX-BLK-01.png" 
                           alt="Memoria RAM" 
                           class="w-full h-48 object-contain">
                  </div>
                  <div class="p-4">
